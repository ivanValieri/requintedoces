...
const PartnersSection = () => {
  return (
    <section className="w-full py-12 bg-[#97DFAD] border-t border-[#843809]/30">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-bold text-center text-[#843809] mb-8 font-playfair">Parceiros</h2>
          ...
          {partners.map((partner) => (
            <div key={partner.url} className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <span className="text-base md:text-lg font-semibold text-[#843809]">{partner.name}</span>
                <a
                  href={partner.url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#843809] underline text-xs md:text-sm mt-1"
                >
                  {partner.handle}
                </a>
              </div>
